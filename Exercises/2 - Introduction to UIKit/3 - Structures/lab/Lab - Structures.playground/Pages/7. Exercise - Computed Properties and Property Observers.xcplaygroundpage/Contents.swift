...
struct Height {
    var heightInInches: Double {
        didSet {
            let conversion = heightInInches * 2.54
            if heightInCentimeters != conversion {
                heightInCentimeters = conversion
            }
        }
    }
    ...
    var heightInCentimeters: Double {
        didSet {
            let conversion = heightInCentimeters / 2.54
            if heightInInches != conversion {
                heightInInches = conversion
            }
        }
    }
...
var foo = Height(heightInInches: 10)
foo.heightInCentimeters = 100
print(foo.heightInInches)
