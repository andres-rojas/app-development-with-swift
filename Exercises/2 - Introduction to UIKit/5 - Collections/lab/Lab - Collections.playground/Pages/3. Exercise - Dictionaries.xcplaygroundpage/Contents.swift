 ...
 */
var daysIn = ["January": 31, "February": 28, "March": 31]
print(daysIn)
 ...
 */
daysIn.updateValue(29, forKey: "February")
print(daysIn)

/*:
 Use if-let syntax to retrieve the number of days under "January". If the value is there, print "January has 31 days", where 31 is the value retrieved from the dictionary.
 */
if let days = daysIn["January"] {
...
let foo = ["Shapes": shapesArray, "Colors": colorsArray]
print(foo)
