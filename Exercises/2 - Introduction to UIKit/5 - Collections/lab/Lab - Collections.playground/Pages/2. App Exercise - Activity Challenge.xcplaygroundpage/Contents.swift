 ...
 */
var walkingChallenges = ["Walk 3 miles a day", "Walk 5 days a week"]
var runningChallenges = ["Run a mile a day", "Run 3 times a week"]
...
} else if acceptedChallenges.count == 1 {
    print("The challenge you have chosen is \(acceptedChallenges[0])")
} else {
