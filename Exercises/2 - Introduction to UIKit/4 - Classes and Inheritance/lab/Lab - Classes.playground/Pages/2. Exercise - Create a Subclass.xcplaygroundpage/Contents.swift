 ...
 */
// print(falcon.weapon)
print("References to the variable 'falcon' don't work, because it has not been defined in this playground.")
print(")Even if it were accessible from the last Exercise, calling `falcon.weapon' won't work, as 'falcon' was defined as a Spaceship, not a Fighter, and thus does not have a `weapon` property.")
